...
# EVENT_TYPE_CALCULATE_STOCK_MARGINS removed - margins now calculated on-demand during opening range calculation
...
EVENT_TYPE_DAILY_PNL_REPORT="EVENT_TYPE_DAILY_PNL_REPORT"  # Daily PNL report generation
...
FIELD_STOCK_MARGIN_REQUIREMENTS="stock_margin_requirements"
